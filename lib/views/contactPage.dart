    ...
    return Column(
      ...
      children: [
        Text(
          "CONTACT ME💬",
          style:
              GoogleFonts.breeSerif(fontSize: 32, fontWeight: FontWeight.w500),
        ),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: CustomTextField(
                  ...
                  title: 'Your name',
                  validator: (value) {
                    if (value == null || value == '') return "Enter name";
                    return null;
                  },
                ),
              ),
          ...
          CustomTextField(
            ...
            title: 'Subject',
            validator: (value) {
              if (value == null || value == '') return "Enter Subject";
              return null;
            },
          ),
          CustomTextField(
              ...
              title: 'Message',
              validator: (value) {
                if (value == null || value == '') return "Enter message";
                return null;
              },
              maxLines: 4),
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                String email = Uri.encodeComponent(PersonalDetails.email);
